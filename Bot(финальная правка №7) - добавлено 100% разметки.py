...
def test_first_buttons(message):
    ...
    btn1 = types.InlineKeyboardButton("🏋️‍♂️ Пауэрлифтинг и силовые", callback_data="tab1")
    btn2 = types.InlineKeyboardButton("💪 Бодибилдинг", callback_data="tab2")
    btn3 = types.InlineKeyboardButton("👥 Авторы", callback_data="tab3")
    btn4 = types.InlineKeyboardButton("🏛 Рандомная тренировка", callback_data="tab4")
    btn5 = types.InlineKeyboardButton("📚 Гайды", callback_data="tab5")

    # Расположение кнопок как на скриншоте
    markup.row(btn1)          # первая строка — одна широкая кнопка
    markup.row(btn2, btn3)    # вторая строка — две кнопки
    markup.row(btn4, btn5)    # третья строка — две кнопки
...
def handle_tabs(call):
    ...
    tabs_content = {
        "1": "<b>🏋️ Пауэрлифтинг и силовые</b>\n\nВыберите уровень подготовки:",
        "2": "<b>💪 Бодибилдинг</b>\n\nВыберите пол:",
        "3": "<b>👥 Авторы</b>\n\nИнформация о создателях бота:",
        "4": "<b>🎲 Рандомная тренировка</b>\n\nВыберите сложность:",
        "5": "<b>📚 Гайды</b>\n\nВыберите руководство:"
    }

    # ---------------------- Вкладка 1 ----------------------
    if tab_number == "1":
        btn1 = types.InlineKeyboardButton("🟢 Начальный", callback_data="power_easy")
        btn2 = types.InlineKeyboardButton("🟡 Средний", callback_data="power_normal")
        btn3 = types.InlineKeyboardButton("🔴 Продвинутый уровень", callback_data="power_advanced")
        btn4 = types.InlineKeyboardButton(" Жимовые раскладки", callback_data="bench_press")
        btn5 = types.InlineKeyboardButton(" Стритлифтинг", callback_data="streetlifting")
        btn6 = types.InlineKeyboardButton("◀ Назад в меню", callback_data="back_menu")
    ...
    # ---------------------- Вкладка 2 ----------------------
        ...
        btn1 = types.InlineKeyboardButton("🧔🏻 Мужчина", callback_data="gender_man")
        btn2 = types.InlineKeyboardButton("👩🏻‍🦱 Женщина", callback_data="gender_woman")
        btn3 = types.InlineKeyboardButton("◀ Назад в меню", callback_data="back_menu")
    ...
    # ---------------------- Вкладка 3 ----------------------
        ...
        btn1 = types.InlineKeyboardButton("👨‍💻 О команде", callback_data="about_team")
        btn2 = types.InlineKeyboardButton("📝 Авторы", callback_data="about_creators")
        btn3 = types.InlineKeyboardButton("◀ Назад в меню", callback_data="back_menu")
    ...
    # ---------------------- Вкладка 4 ----------------------
        ...
        btn1 = types.InlineKeyboardButton("🟢 Легкая", callback_data="difficulty_easy")
        btn2 = types.InlineKeyboardButton("🟡 Средняя", callback_data="difficulty_normal")
        btn3 =types.InlineKeyboardButton("🔴 Тяжелая", callback_data="difficulty_hard")
        btn4 = types.InlineKeyboardButton("◀ Назад в меню", callback_data="back_menu")
    ...
    # ---------------------- Вкладка 5 ----------------------
        ...
        tabs_buttons = [
            ["📖 МАССОНАБОРНЫЙ ГАЙД", "https://telegra.ph/Hh-06-01-10"],
    ...
    # ---------------------- Остальные вкладки ----------------------
        ...
        markup.add(types.InlineKeyboardButton("◀ Назад в меню", callback_data="back_menu"))
...
def handle_gender_selection(call):
    ...
    btn1 = types.InlineKeyboardButton("🟢Меньше года", callback_data=f"experience_less_{call.data}")
    btn2 = types.InlineKeyboardButton("🟡1-3 года", callback_data=f"experience_1-3_{call.data}")
    btn3 = types.InlineKeyboardButton("🔴Больше 3 лет", callback_data=f"experience_more3_{call.data}")
    btn4 = types.InlineKeyboardButton("Назад", callback_data="tab2")
...
def handle_experience_selection(call):
    ...
    if experience == "less":
        ...
        btn1 = types.InlineKeyboardButton("🐘2x2", callback_data=f"schedule_2-2_{gender}_{experience}")
        btn2 = types.InlineKeyboardButton("🦍3 дня", callback_data=f"schedule_3days_{gender}_{experience}")
        btn3 = types.InlineKeyboardButton("Назад", callback_data=f"{gender}")
        ...
        btn1 = types.InlineKeyboardButton("✅ Да", callback_data=f"specialization_yes_{gender}_{experience}")
        btn2 = types.InlineKeyboardButton("❌ Нет", callback_data=f"specialization_no_{gender}_{experience}")
        btn3 = types.InlineKeyboardButton("Назад", callback_data=f"{gender}")
...
def handle_specialization_selection(call):
    ...
    if needs_specialization == "no":
        ...
        btn1 = types.InlineKeyboardButton("🐘2x2", callback_data=f"schedule_2-2_{gender}_{experience}")
        btn2 = types.InlineKeyboardButton("🦍3 дня", callback_data=f"schedule_3days_{gender}_{experience}")
        btn3 = types.InlineKeyboardButton("Назад", callback_data=f"experience_{experience}_{gender}")
        ...
        btn1 = types.InlineKeyboardButton("Спина", callback_data=f"muscle_back_{gender}_{experience}")
        btn2 = types.InlineKeyboardButton("Ноги", callback_data=f"muscle_legs_{gender}_{experience}")
        btn3 = types.InlineKeyboardButton("Руки", callback_data=f"muscle_arms_{gender}_{experience}")
        btn4 = types.InlineKeyboardButton("Грудь", callback_data=f"muscle_chest_{gender}_{experience}")
        btn5 = types.InlineKeyboardButton("Плечи", callback_data=f"muscle_shoulders_{gender}_{experience}")
        btn6 = types.InlineKeyboardButton("Грудь+Спина", callback_data=f"muscle_chest-back_{gender}_{experience}")
        btn7 = types.InlineKeyboardButton("Руки+Плечи", callback_data=f"muscle_arms-shoulders_{gender}_{experience}")
        btn8 = types.InlineKeyboardButton("⬅️Назад", callback_data=f"experience_{experience}_{gender}")
...
def handle_muscle_selection(call):
    ...
    btn1 = types.InlineKeyboardButton("🐘2x2", callback_data=f"schedule_2-2_{gender}_{experience}_{muscle_group}")
    btn2 = types.InlineKeyboardButton("🦍3 дня", callback_data=f"schedule_3days_{gender}_{experience}_{muscle_group}")
    btn3 =types.InlineKeyboardButton("Назад", callback_data=f"specialization_yes_{gender}_{experience}")
...
@bot.callback_query_handler(func=lambda call: call.data.startswith ("power_") or call.data == "bench_press" or call.data == "streetlifting")
def handle_powerlifting_selection(call):

    if call.data == "power_easy":
        file_path = "C:/Users/brfzi/OneDrive/Рабочий стол/Бот для телеги/Паверлифтинг/Цикл начального уровня.xlsx"
        if os.path.exists(file_path):
            with open(file_path, "rb") as f:
                bot.send_document(call.message.chat.id,f,caption = "Уровень: 🟢Начальный")
        else:
            bot.send_message(call.message.chat.id, "Файл Цикл начального уровня.xlsx не найден ❌")
    
    elif call.data == "power_normal":
        file_path = "C:/Users/brfzi/OneDrive/Рабочий стол/Бот для телеги/Паверлифтинг/Цикл на 4 дня для среднего уровня.xlsx"
        if os.path.exists(file_path):
            with open(file_path, "rb") as f:
                bot.send_document(call.message.chat.id,f,caption = "Уровень: 🟡Средний")
        else:
            bot.send_message(call.message.chat.id, "Файл Цикл на 4 дня для среднего уровня.xlsx не найден ❌")
    
    elif call.data == "power_advanced":
        file_path = "C:/Users/brfzi/OneDrive/Рабочий стол/Бот для телеги/Паверлифтинг/Линейный цикл для продвинутых.xlsx"
        if os.path.exists(file_path):
            with open(file_path, "rb") as f:
                bot.send_document(call.message.chat.id,f,caption = "Уровень: 🔴Продвинутый")
        else:
            bot.send_message(call.message.chat.id, "Файл Линейный цикл для продвинутых не найден ❌")

    elif call.data == "bench_press":
        file_path = "C:/Users/brfzi/OneDrive/Рабочий стол/Бот для телеги/Паверлифтинг/bench_presses_article.docx"
        if os.path.exists(file_path):
            with open(file_path, "rb") as f:
                bot.send_document(call.message.chat.id,f,caption = "Жимовая раскладка:")
        else:
            bot.send_message(call.message.chat.id, "Файл bench_presses_article.docx не найден ❌")

    elif call.data == "streetlifting":
        file_path = "C:/Users/brfzi/OneDrive/Рабочий стол/Бот для телеги/Паверлифтинг/Streetlifting.xlsx"
        if os.path.exists(file_path):
            with open(file_path,"rb") as f:
                bot.send_document(call.message.chat.id,f,caption = "Стритлифтинг:")
        else:
            bot.send_message(call.message.chat.id, "Файл Streetlifting.xlsx не найден ❌")

    markup = types.InlineKeyboardMarkup()
    button = types.InlineKeyboardButton("⬅️Назад к выбору уровня", callback_data= "tab1")
    markup.add(button)

    caption = f"🏋🏻‍♂️ Пауэрлифтинг и силовые\n\n" \
              f"— Вот все программы, которые мне удалось найти. Приятной тренировки!\n" 
...
def back_menu(call):
    ...
    chat_id=call.message.chat.id, 
    message_id=call.message.message_id,#
    text="⚡ Добро пожаловать в бота, в котором вы можете получить тренировку для себя и не платить ни копейки!",
    reply_markup=markup
  )
    bot.answer_callback_query(call.id)
